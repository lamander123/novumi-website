      ...
      <section className="py-20 md:py-28 bg-gray-50">
        <Container>
          ...
          <div className="grid md:grid-cols-3 gap-8 max-w-4xl mx-auto">
            {processSteps.map(({ titleKey, descKey }, i) => (
              <div key={i} className="text-center">
                <div className="inline-flex items-center justify-center w-10 h-10 rounded-full bg-gray-900 text-white text-sm font-medium mb-4">
                  {i + 1}
                </div>
