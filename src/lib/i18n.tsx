...
const translations: Record<Language, Record<string, string>> = {
  nl: {
    ...
    // Hero
    'hero.title': 'Screening die vindt wat anderen missen.',
    'hero.subtitle': 'We combineren traditioneel onderzoek met digitale expertise. Zo vinden we risico\'s die standaard checks missen.',
    'hero.cta.primary': 'Plan een gesprek',
    'hero.cta.secondary': 'Bekijk diensten',

    // Problem section
    'problem.title': 'Het probleem met standaard screening',
    'problem.text': 'Een VOG vertelt je alleen of iemand veroordeeld is—niet of diegene de waarheid vertelt. Standaard screeningbureaus checken databases, maar bellen zelden de vorige werkgever. En niemand kijkt naar wat online te vinden is.',

    // Solution section
    'solution.title': 'Onze aanpak',
    'solution.text': 'Novumi combineert de grondigheid van een traditioneel onderzoeksbureau met digitale expertise. We verifiëren niet alleen—we onderzoeken.',

    // Process section
    'process.title': 'Hoe het werkt',
    'process.step1.title': 'Aanvraag',
    'process.step1.desc': 'Dien een aanvraag in via ons portaal. Wij regelen de toestemming met de kandidaat.',
    'process.step2.title': 'Onderzoek',
    'process.step2.desc': 'Ons team checkt alles bij de bron en doet digitaal onderzoek.',
    'process.step3.title': 'Rapport',
    'process.step3.desc': 'Je ontvangt een helder rapport met bevindingen en risico-indicatoren. Binnen 48-72 uur.',

    // Benefits
    'benefits.title': 'Waarom Novumi',
    'benefit1.title': 'Verificatie bij de bron',
    'benefit1.desc': 'We bellen vorige werkgevers. Checken bij opleidingen. Verifiëren licenties bij beroepsregisters.',
    'benefit2.title': 'OSINT-expertise',
    'benefit2.desc': 'We analyseren sociale media, openbare registers en digitale sporen om te vinden wat traditionele screening mist.',
    'benefit3.title': 'Rapporten waar je wat aan hebt',
    'benefit3.desc': 'Geen jargon of vage bevindingen. Onze rapporten geven een helder beeld met concrete risico-indicatoren.',
    'benefit4.title': 'AVG-compliant proces',
    'benefit4.desc': 'Volledig volgens de AVG en Nederlandse privacywetgeving. Data blijft binnen de EU.',
    ...
    // CTA
    'cta.title': 'Wil je zeker weten wie je aanneemt?',
    'cta.desc': 'Plan een vrijblijvend gesprek. We leggen onze aanpak uit en bespreken welke screening past bij jouw organisatie.',
    'cta.button': 'Plan een gesprek',

    // Services page
    'services.hero.title': 'Onze Diensten',
    'services.hero.subtitle': 'Van referentieverificatie tot digitale analyse—screening afgestemd op jouw risicoprofiel en sector.',
    'services.background.title': 'Achtergrondverificatie',
    'services.background.desc': 'Verificatie van werkervaring, opleidingen en referenties rechtstreeks bij de bron.',
    'services.criminal.title': 'Strafrechtelijke Screening',
    'services.criminal.desc': 'Check van justitiële documentatie en sanctielijsten in binnen- en buitenland.',
    ...
    'services.financial.desc': 'Integriteitscheck voor functies met financiële verantwoordelijkheid.',
    'services.cta.title': 'Oplossing op maat nodig?',
    'services.cta.desc': 'Elke organisatie heeft een eigen risicoprofiel. Laten we bespreken hoe we onze diensten kunnen afstemmen op jouw behoeften.',

    // FAQ
    'faq.title': 'Veelgestelde vragen',
    'faq.q1': 'Hoe lang duurt een screening?',
    'faq.a1': 'Standaard achtergrondonderzoeken zijn binnen 48-72 uur klaar. Uitgebreide screenings met internationale verificaties duren 5-7 werkdagen.',
    'faq.q2': 'Is toestemming van de kandidaat nodig?',
    'faq.a2': 'Ja. We werken volledig volgens de AVG. Voordat we beginnen, regelen we een transparant toestemmingsproces met de kandidaat.',
    'faq.q3': 'Wat is het verschil met een VOG?',
    'faq.a3': 'Een VOG laat alleen zien of iemand relevante strafrechtelijke antecedenten heeft. Onze screening checkt ook werkervaring, opleidingen, referenties en digitale aanwezigheid.',
    'faq.q4': 'Bieden jullie internationale screening aan?',
    'faq.a4': 'Ja. We verifiëren gegevens in de meeste Europese landen en daarbuiten. Doorlooptijden en beschikbare checks verschillen per land.',
    'faq.q5': 'Hoe zit het met databeveiliging?',
    'faq.a5': 'We werken met sterke beveiligingsmaatregelen: versleutelde dataoverdracht, beveiligde opslag en regelmatige audits. Alle data blijft binnen de EU.',

    // About page
    'about.hero.title': 'Over Novumi',
    'about.hero.subtitle': 'We verbinden traditioneel onderzoek met moderne digitale expertise.',
    'about.story.title': 'Ons Verhaal',
    'about.story.p1': 'Onze naam komt van het Latijnse woord "novum", dat nieuw of nieuwe feiten betekent. Het weerspiegelt onze missie: relevante informatie boven tafel krijgen die ertoe doet voor jouw beslissingen.',
    'about.story.p2': 'Traditionele onderzoekers zijn goed in achtergrondchecks maar missen vaak digitale red flags. Cybersecuritybedrijven snappen technische dreigingen maar zien soms de menselijke factor over het hoofd. Wij brengen die twee werelden samen.',
    'about.values.title': 'Onze Waarden',
    'about.value1.title': 'Waarheid',
    'about.value1.desc': 'We gaan tot de bodem, ongeacht waar het ons brengt.',
    'about.value2.title': 'Privacy',
    'about.value2.desc': 'We gaan zorgvuldig om met gevoelige informatie.',
    'about.value3.title': 'Helderheid',
    'about.value3.desc': 'Complexe bevindingen hebben geen waarde als ze niet te begrijpen zijn.',

    // Contact page
    'contact.hero.title': 'Neem Contact Op',
    'contact.hero.subtitle': 'Vragen over onze diensten? We helpen je graag.',
    ...
    'contact.form.success': 'Bericht verzonden! We nemen binnen 24 uur contact met je op.',
